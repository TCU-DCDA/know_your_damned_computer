...
subtitle: "Navigating Your Computer's Address System"
author: "Curt Rode"
date: last-modified
difficulty: beginner
...
- Identify platform-specific path conventions (Mac vs. PC)
- Use common path shortcuts and environment variables
- Troubleshoot common path-related errors in DH projects
:::
...
Now that you understand file paths, you're ready to learn about [working with compressed files](compression.qmd), which often involve specifying exact paths for extraction and archiving.
