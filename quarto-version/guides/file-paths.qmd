...
AI can't find your file if you can't describe where it is. When you tell an AI assistant "open my data file" and it asks for the path, you need to know the answer. When AI-generated code throws `FileNotFoundError`, you need to understand why the path is wrong and how to fix it. This is the single most common error students hit when working with AI coding tools.
:::
