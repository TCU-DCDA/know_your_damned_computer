...
<div class="terminal-simulator" data-terminal="path-navigation">
  ...
  <div class="command-examples">
    <div class="command-demo">
      <code>pwd</code>
      <span class="command-desc">← Shows current directory</span>
    </div>
    <div class="command-demo">
      <code>ls .</code>
      <span class="command-desc">← List current directory</span>
    </div>
    <div class="command-demo">
      <code>ls ..</code>
      <span class="command-desc">← List parent directory</span>
    </div>
    <div class="command-demo">
      <code>cd ../</code>
      <span class="command-desc">← Move to parent directory</span>
    </div>
  </div>
</div>
