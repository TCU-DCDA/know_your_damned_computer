...
AI-generated code assumes a file format. If it writes a script expecting CSV but your data is TSV, or it reads JSON when you have XML, the code will break — and the error message won't say "wrong format." You need to recognize what format you're working with and catch the mismatch yourself.
:::
...
Understanding file formats prepares you for [command line work](command-line.qmd), where you'll learn to navigate files and run Python scripts efficiently from the terminal.
