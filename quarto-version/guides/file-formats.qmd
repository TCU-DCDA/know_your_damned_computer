...
subtitle: "Speaking the Language of Data"
author: "Curt Rode"
date: last-modified
difficulty: beginner
...
- Distinguish between text, data, image, and code formats
- Choose the appropriate file format for your DH research
- Convert between common formats (e.g., Excel to CSV)
- Understand the importance of character encoding (UTF-8)
:::
...
::: {.callout-important}
## Important
When sharing research data, convert Word docs to plain text or CSV for analysis.
:::
...
::: {.callout-tip}
## Python Tip
Always export to CSV for analysis, but keep Excel original for reference.
:::
...
Understanding file formats prepares you for [command line basics](command-line.qmd), where you'll learn to navigate and manipulate these files efficiently using text commands - a crucial skill for Python-based DH work.
