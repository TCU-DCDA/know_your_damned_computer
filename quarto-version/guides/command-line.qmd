...
AI will give you terminal commands. Copy-pasting them without understanding what they do is how you accidentally delete files, install the wrong package, or run something with elevated privileges you didn't intend. Every command AI suggests — `pip install`, `git push`, `rm -rf` — you need to know what it does before you hit Enter.
:::
...
Try the navigation commands above in the simulator below. Type `help` for available commands.

```{=html}
<div data-terminal="navigation-practice"></div>
```
## File Operations
...
::: {.callout-tip}
## Try It Yourself
Use the simulated terminal below to practice these commands safely. You can navigate directories, create files, and even simulate running Python scripts!
:::

```{=html}
<div data-terminal="main"></div>
```
...
With command line skills mastered, you're ready to tackle [text encoding and character sets](text-encoding.qmd), where you'll learn to handle multilingual and historical texts without garbled characters.
