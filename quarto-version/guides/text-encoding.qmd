...
AI won't tell you your corpus is UTF-16 when your script expects UTF-8. It will generate code that opens files with a default encoding, and when your historical French texts or multilingual dataset come back as garbled nonsense, the AI will confidently suggest fixes that don't address the root cause. You need to recognize encoding problems yourself — they're invisible to tools that don't know what the text is supposed to look like.
:::
