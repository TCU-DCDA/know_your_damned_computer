...
When AI tells you to "untar the dataset" or "extract the archive," you need to know what that means and how to do it. AI tools routinely generate instructions that assume you understand compression — downloading model files, unpacking datasets, bundling project folders for sharing. This guide gives you that foundation.
:::
