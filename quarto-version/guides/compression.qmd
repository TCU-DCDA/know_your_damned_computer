...
subtitle: "Managing Archives and Saving Space"
author: "Curt Rode"
date: last-modified
difficulty: beginner
...
- Identify common compressed file formats used in DH
- Create and extract ZIP archives on Mac and PC
- Use command-line tools for advanced compression tasks
- Troubleshoot common archive errors
:::
