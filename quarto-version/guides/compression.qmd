...
<div class="exercise" data-exercise="first-archive">
  ...
  <button class="btn btn-success kydc-exercise" data-exercise-id="first-archive">Mark Complete</button>
</div>
```
...
└── scripts/
  ...
  <button class="btn btn-success kydc-exercise" data-exercise-id="dh-scenario">Mark Complete</button>
</div>
```
