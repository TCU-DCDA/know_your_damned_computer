...
<div class="exercise" data-exercise="first-archive">
  ...
  <button class="btn btn-success kydc-exercise-complete" data-exercise="first-archive">Mark Complete</button>
</div>
```
...
└── scripts/
  ...
  <button class="btn btn-success kydc-exercise-complete" data-exercise="dh-scenario">Mark Complete</button>
</div>
```
